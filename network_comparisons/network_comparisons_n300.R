...
setEPS()
postscript("FigS10.eps", width = 12, height = 3*8)   


par(mfrow=c(8,4))
data_R <-scale_free_p_100_n_300_huge_data[,,n_net]; adjacency_correct <- scale_free_p_100_n_300_huge_adjacency[,,n_net]
qgraph::qgraph(labels=FALSE,adjacency_correct,title="The true network, huge, Scale-free")
data_R <-cluster_p_100_n_300_huge_data[,,n_net]; adjacency_correct <- cluster_p_100_n_300_huge_adjacency[,,n_net]
qgraph::qgraph(labels=FALSE,adjacency_correct,title="The true network, huge, Cluster")
data_R <-scale_free_p_100_n_300_bdgraph_data[,,n_net]; adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
qgraph::qgraph(labels=FALSE,adjacency_correct,title="The true network, BDgraph, Scale-free")
data_R <-cluster_p_100_n_300_bdgraph_data[,,n_net]; adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
...
sum(cluster_p_100_n_300_huge_adjacency[,,n_net])/2

sum(cluster_p_100_n_300_bdgraph_adjacency[,,n_net])/2
...
# 
# par(mfrow=c(1,4))
adjacency_correct <- scale_free_p_100_n_300_huge_adjacency[,,n_net]
load(file="results/huge/results_HMF_Z_CC_scale_free_p100_n300_huge_data.RData")
admat <- results_HMF_Z_CC_scale_free_p100_n300_huge_data[,,n_net]
...
adjacency_correct <- cluster_p_100_n_300_huge_adjacency[,,n_net]
load(file="results/huge/results_HMF_Z_CC_cluster_p100_n300_huge_data.RData")
admat <- results_HMF_Z_CC_cluster_p100_n300_huge_data[,,n_net] 
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, CC, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_HMF_Z_CC_scale_free_p100_n300_bdgraph_data.RData")
admat <-results_HMF_Z_CC_scale_free_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, CC, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_HMF_Z_CC_cluster_p100_n300_bdgraph_data.RData")
admat <- results_HMF_Z_CC_cluster_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, CC, ",names[Value]," = ",round(V,round_value)))
...
admat <- results_G_wishart_scale_free_p100_n300_huge_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
admat <- results_G_wishart_cluster_p100_n300_huge_data[,,n_net] 
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("G-WISHART, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_G_wishart_scale_free_p100_n300_bdgraph_data.RData")
admat <-results_G_wishart_scale_free_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("G-WISHART, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_G_wishart_cluster_p100_n300_bdgraph_data.RData")
admat <- results_G_wishart_cluster_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("G-WISHART, ",names[Value]," = ",round(V,round_value)))
...
admat <- results_TIGER_scale_free_p100_n300_huge_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
admat <- results_TIGER_cluster_p100_n300_huge_data[,,n_net] 
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("TIGER, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_TIGER_scale_free_p100_n300_bdgraph_data.RData")
admat <-results_TIGER_scale_free_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("TIGER, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_TIGER_cluster_p100_n300_bdgraph_data.RData")
admat <- results_TIGER_cluster_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("TIGER, ",names[Value]," = ",round(V,round_value)))
...
admat <- results_glasso_scale_free_p100_n300_huge_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
admat <- results_glasso_cluster_p100_n300_huge_data[,,n_net] 
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("glasso, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_glasso_scale_free_p100_n300_bdgraph_data.RData")
admat <-results_glasso_scale_free_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("glasso, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_glasso_cluster_p100_n300_bdgraph_data.RData")
admat <- results_glasso_cluster_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("glasso, ",names[Value]," = ",round(V,round_value)))
...
admat <- results_THAV_scale_free_p100_n300_huge_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
admat <- results_THAV_cluster_p100_n300_huge_data[,,n_net] 
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("THAV, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_THAV_scale_free_p100_n300_bdgraph_data.RData")
admat <-results_THAV_scale_free_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("THAV, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_THAV_cluster_p100_n300_bdgraph_data.RData")
admat <- results_THAV_cluster_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("THAV, ",names[Value]," = ",round(V,round_value)))
...
# admat <- results_clevel_scale_free_p100_n300_huge_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
# admat <- results_clevel_cluster_p100_n300_huge_data[,,n_net] 
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("clevel, ",names[Value]," = ",round(V,round_value)))
# 
# adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
# load(file="results/bdgraph/results_clevel_scale_free_p100_n300_bdgraph_data.RData")
# admat <-results_clevel_scale_free_p100_n300_bdgraph_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("clevel, ",names[Value]," = ",round(V,round_value)))
# 
# adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
# load(file="results/bdgraph/results_clevel_cluster_p100_n300_bdgraph_data.RData")
# admat <- results_clevel_cluster_p100_n300_bdgraph_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("clevel, ",names[Value]," = ",round(V,round_value)))
...
admat <- results_clevel_d_scale_free_p100_n300_huge_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
admat <- results_clevel_d_cluster_p100_n300_huge_data[,,n_net] 
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("clevel (target FDR = 0.05), ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_clevel_d_scale_free_p100_n300_bdgraph_data.RData")
admat <-results_clevel_d_scale_free_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("clevel (target FDR = 0.05), ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_clevel_d_cluster_p100_n300_bdgraph_data.RData")
admat <- results_clevel_d_cluster_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("clevel (target FDR = 0.05), ",names[Value]," = ",round(V,round_value)))
...
admat <- results_beam_scale_free_p100_n300_huge_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
admat <- results_beam_cluster_p100_n300_huge_data[,,n_net] 
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("beam, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_beam_scale_free_p100_n300_bdgraph_data.RData")
admat <-results_beam_scale_free_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("beam, ",names[Value]," = ",round(V,round_value)))

adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
load(file="results/bdgraph/results_beam_cluster_p100_n300_bdgraph_data.RData")
admat <- results_beam_cluster_p100_n300_bdgraph_data[,,n_net]
V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
qgraph::qgraph(labels=FALSE,admat,title=paste0("beam, ",names[Value]," = ",round(V,round_value)))
...
# admat <- results_HMF_Z_scale_free_p100_n300_huge_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
# admat <- results_HMF_Z_cluster_p100_n300_huge_data[,,n_net] 
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, 10x, ",names[Value]," = ",round(V,round_value)))
# 
# adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
# load(file="results/bdgraph/results_HMF_Z_scale_free_p100_n300_bdgraph_data.RData")
# admat <-results_HMF_Z_scale_free_p100_n300_bdgraph_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, 10x, ",names[Value]," = ",round(V,round_value)))
# 
# adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
# load(file="results/bdgraph/results_HMF_Z_cluster_p100_n300_bdgraph_data.RData")
# admat <- results_HMF_Z_cluster_p100_n300_bdgraph_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, 10x, ",names[Value]," = ",round(V,round_value)))
# 
# # dev.off()
...
# admat <- results_HMF_Z2x_scale_free_p100_n300_huge_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
...
# admat <- results_HMF_Z2x_cluster_p100_n300_huge_data[,,n_net] 
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, 2x, ",names[Value]," = ",round(V,round_value)))
# 
# adjacency_correct <- scale_free_p_100_n_300_bdgraph_adjacency[,,n_net]
# load(file="results/bdgraph/results_HMF_Z2x_scale_free_p100_n300_bdgraph_data.RData")
# admat <-results_HMF_Z2x_scale_free_p100_n300_bdgraph_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, 2x, ",names[Value]," = ",round(V,round_value)))
# 
# adjacency_correct <- cluster_p_100_n_300_bdgraph_adjacency[,,n_net]
# load(file="results/bdgraph/results_HMF_Z2x_cluster_p100_n300_bdgraph_data.RData")
# admat <- results_HMF_Z2x_cluster_p100_n300_bdgraph_data[,,n_net]
# V <- calculate_scores(tarkkuus(adjacency_correct, admat))[Value]
# qgraph::qgraph(labels=FALSE,admat,title=paste0("HMFGraph, 2x, ",names[Value]," = ",round(V,round_value)))
