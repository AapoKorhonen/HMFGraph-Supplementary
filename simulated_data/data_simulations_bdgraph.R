...
random_p_200_n_100_bdgraph_data<- array( 0, dim = c( n ,p , t1 ) )
random_p_200_n_100_bdgraph_adjacency<- array( 0, dim = c( p ,p , t1 ) )
...
for(i in 1:t1){
  ...
  random_p_200_n_100_bdgraph_data[,,i] <-graph_data$data
  ...
  random_p_200_n_100_bdgraph_adjacency[,,i] <-graph_data$K
}

save(random_p_200_n_100_bdgraph_data,file = "simulated_data/bdgraph/random_p_200_n_100_bdgraph_data.RData")
save(random_p_200_n_100_bdgraph_adjacency,file = "simulated_data/bdgraph/random_p_200_n_100_bdgraph_adjacency.RData")
...
cluster_p_200_n_100_bdgraph_data<- array( 0, dim = c( n ,p , t1 ) )
cluster_p_200_n_100_bdgraph_adjacency<- array( 0, dim = c( p ,p , t1 ) )
...
for(i in 1:t1){
  ...
  cluster_p_200_n_100_bdgraph_data[,,i] <-graph_data$data
  ...
  cluster_p_200_n_100_bdgraph_adjacency[,,i] <-graph_data$K
}

save(cluster_p_200_n_100_bdgraph_data,file = "simulated_data/bdgraph/cluster_p_200_n_100_bdgraph_data.RData")
save(cluster_p_200_n_100_bdgraph_adjacency,file = "simulated_data/bdgraph/cluster_p_200_n_100_bdgraph_adjacency.RData")


#=========================================================================
# Scale-Free N = 100, P = 200
#=========================================================================

scale_free_p_200_n_100_bdgraph_data<- array( 0, dim = c( n ,p , t1 ) )
scale_free_p_200_n_100_bdgraph_adjacency<- array( 0, dim = c( p ,p , t1 ) )
...
for(i in 1:t1){
  ...
  scale_free_p_200_n_100_bdgraph_data[,,i] <-graph_data$data
  ...
  scale_free_p_200_n_100_bdgraph_adjacency[,,i] <-graph_data$K
}

save(scale_free_p_200_n_100_bdgraph_data,file = "simulated_data/bdgraph/scale_free_p_200_n_100_bdgraph_data.RData")
save(scale_free_p_200_n_100_bdgraph_adjacency,file = "simulated_data/bdgraph/scale_free_p_200_n_100_bdgraph_adjacency.RData")
