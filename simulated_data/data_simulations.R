...
random_p_200_n_100_huge_data <- array( 0, dim = c( n ,p , t1 ) )
random_p_200_n_100_huge_adjacency <- array( 0, dim = c( p ,p , t1 ) )
...
for(i in 1:t1){
  ...
  random_p_200_n_100_huge_data[,,i] <-graph_data$data
  ...
  random_p_200_n_100_huge_adjacency[,,i] <-graph_data$omega
}

save(random_p_200_n_100_huge_data ,file = "simulated_data/huge/random_p_200_n_100_huge_data.RData")
save(random_p_200_n_100_huge_adjacency ,file = "simulated_data/huge/random_p_200_n_100_huge_adjacency.RData")
...
cluster_p_200_n_100_huge_data <- array( 0, dim = c( n ,p , t1 ) )
cluster_p_200_n_100_huge_adjacency <- array( 0, dim = c( p ,p , t1 ) )
...
for(i in 1:t1){
  ...
  cluster_p_200_n_100_huge_data[,,i] <-graph_data$data
  ...
  cluster_p_200_n_100_huge_adjacency[,,i] <-graph_data$omega
}

save(cluster_p_200_n_100_huge_data ,file = "simulated_data/huge/cluster_p_200_n_100_huge_data.RData")
save(cluster_p_200_n_100_huge_adjacency ,file = "simulated_data/huge/cluster_p_200_n_100_huge_adjacency.RData")
...
scale_free_p_200_n_100_huge_data <- array( 0, dim = c( n ,p , t1 ) )
scale_free_p_200_n_100_huge_adjacency <- array( 0, dim = c( p ,p , t1 ) )
...
for(i in 1:t1){
  ...
  scale_free_p_200_n_100_huge_data[,,i] <-graph_data$data
  ...
  scale_free_p_200_n_100_huge_adjacency[,,i] <-graph_data$omega
}

save(scale_free_p_200_n_100_huge_data ,file = "simulated_data/huge/scale_free_p_200_n_100_huge_data.RData")
save(scale_free_p_200_n_100_huge_adjacency ,file = "simulated_data/huge/scale_free_p_200_n_100_huge_adjacency.RData")
