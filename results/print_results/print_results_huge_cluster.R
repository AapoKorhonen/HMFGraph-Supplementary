...
Values <- c(15,16,4,14) # Averace Clustering coefficients (ACC), NMI, F1
...
load(file="results/huge/results_HMF_FDR_CC_cluster_p100_n35_huge_data.RData")
load(file="results/huge/results_HMF_FDR_CC_cluster_p100_n75_huge_data.RData")
load(file="results/huge/results_HMF_FDR_CC_cluster_p100_n150_huge_data.RData")
load(file="results/huge/results_HMF_FDR_CC_cluster_p100_n300_huge_data.RData")

results_HMF_FDR_CC <- list(results_HMF_FDR_CC_cluster_p100_n35_huge_data,
                           results_HMF_FDR_CC_cluster_p100_n75_huge_data,
                           results_HMF_FDR_CC_cluster_p100_n150_huge_data,
                           results_HMF_FDR_CC_cluster_p100_n300_huge_data)

load(file="results/huge/results_HMF_P_CC_cluster_p100_n35_huge_data.RData")
load(file="results/huge/results_HMF_P_CC_cluster_p100_n75_huge_data.RData")
load(file="results/huge/results_HMF_P_CC_cluster_p100_n150_huge_data.RData")
load(file="results/huge/results_HMF_P_CC_cluster_p100_n300_huge_data.RData")

results_HMF_P_CC <- list(results_HMF_P_CC_cluster_p100_n35_huge_data,
...
load(file="results/huge/results_BGGM_cluster_p100_n150_huge_data.RData")
load(file="results/huge/results_BGGM_cluster_p100_n300_huge_data.RData")

results_BGGM <- list(results_BGGM_cluster_p100_n150_huge_data,
                      results_BGGM_cluster_p100_n300_huge_data)
