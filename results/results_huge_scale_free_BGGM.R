...
results_BGGM_scale_free_p100_n150_huge_data  <- vector_to_array(results_BGGM,p)

save(results_BGGM_scale_free_p100_n150_huge_data, file="results/huge/results_BGGM_scale_free_p100_n150_huge_data.RData")
...
results_BGGM_scale_free_p100_n300_huge_data  <- vector_to_array(results_BGGM,p)

save(results_BGGM_scale_free_p100_n300_huge_data, file="results/huge/results_BGGM_scale_free_p100_n300_huge_data.RData")
