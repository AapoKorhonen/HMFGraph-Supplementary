...
results_BGGM_scale_free_p100_n150_bdgraph_data  <- vector_to_array(results_BGGM,p)

save(results_BGGM_scale_free_p100_n150_bdgraph_data, file="results/bdgraph/results_BGGM_scale_free_p100_n150_bdgraph_data.RData")
...
results_BGGM_scale_free_p100_n300_bdgraph_data  <- vector_to_array(results_BGGM,p)

save(results_BGGM_scale_free_p100_n300_bdgraph_data, file="results/bdgraph/results_BGGM_scale_free_p100_n300_bdgraph_data.RData")
