...
setEPS()
postscript("beta_values_a_080_offdiagonals.eps", width = 10, height = 11)   # koko oletuksena tuumina
...
results_GEM <- HMFGraph::HMFGraph_GEM(data_R, alpha =0.8, beta=0.95)

plot(density(results_GEM$omega[lower.tri(graph_data$omega)])  , col=colors[1], lty =1, xlim=c(-0.15,0.25)
...
# beta=0.90
#====================================
results_GEM <- HMFGraph::HMFGraph_GEM(data_R, alpha =0.8, beta=0.90)
...
# beta=0.80
#====================================
results_GEM <- HMFGraph::HMFGraph_GEM(data_R, alpha =0.8, beta=0.80)
...
# beta=0.70
#====================================
results_GEM <- HMFGraph::HMFGraph_GEM(data_R, alpha =0.8, beta=0.70)
...
# beta=0.60
#====================================
results_GEM <- HMFGraph::HMFGraph_GEM(data_R, alpha =0.8, beta=0.60)
